...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_statement_block = 28,           /* statement_block  */
...
static const char *const yytname[] =
{
  ...
  "DEF", "RETURN", "IF", "ELSE", "WHILE", "PLUS", "MINUS", "MULT", "DIV",
  "ASSIGN", "EQ", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "COLON", "COMMA",
  "SEMI", "$accept", "program", "function_list", "function", "param_list",
